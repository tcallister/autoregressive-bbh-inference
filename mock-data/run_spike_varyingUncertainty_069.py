...
"""
This script runs an autoregressive population inference on the mock data in `spike_samples_varyingUncertainty.npy`,
...
sampleDict = np.load('spike_samples_varyingUncertainty.npy',allow_pickle=True)[()]
...
az.to_netcdf(data,"ar_spike_varyingUncertainty_069.cdf")
np.save('ar_spike_varyingUncertainty_069_data.npy',full_data)
