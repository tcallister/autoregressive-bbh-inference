...
"""
This script runs an autoregressive population inference on the mock data in `gaussian_samples_varyingUncertainty.npy`,
...
sampleDict = np.load('gaussian_samples_varyingUncertainty.npy',allow_pickle=True)[()]
...
az.to_netcdf(data,"ar_gaussian_varyingUncertainty_069.cdf")
np.save('ar_gaussian_varyingUncertainty_069_data.npy',full_data)
