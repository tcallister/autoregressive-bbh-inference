...
"""
This script runs an autoregressive population inference on the mock data in `half_normal_samples_varyingUncertainty.npy`,
...
sampleDict = np.load('half_normal_samples_varyingUncertainty.npy',allow_pickle=True)[()]
...
kernel = NUTS(ar_model,init_strategy=init_to_median)
...
az.to_netcdf(data,"ar_half_normal_varyingUncertainty_069.cdf")
np.save('ar_half_normal_varyingUncertainty_069_data.npy',full_data)
