...
inference_data = az.from_netcdf("/Volumes/LaCie/cca/autoregressive-bbh-inference-data-resubmission/ar_z.cdf")
...
z_data = np.load('/Volumes/LaCie/cca/autoregressive-bbh-inference-data-resubmission/ar_z_data.npy',allow_pickle=True)[()]
...
hfile = h5py.File('/Volumes/LaCie/cca/autoregressive-bbh-inference-data-resubmission/for-data-release/ar_z_summary.hdf','w')
